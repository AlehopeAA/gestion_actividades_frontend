...
export const getSubdirections = () => async (dispatch, getState) => {
  try {
...
export const getSubdirectionsRelated = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      '/api/perfilsubdirecciones/relacionados',
      {},
      config
    )
...
export const subdirectionUpdateInfo = (subdireccion) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `/api/perfilsubdirecciones/${subdireccion.id_subdireccion}`,
      subdireccion,
      config
    )
